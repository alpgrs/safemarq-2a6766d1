...
const Terms = () => (
  <LegalLayout title="Conditions Générales d'Utilisation" description="CGU de la plateforme SAFEMARQ.">
    <h2>1. Objet</h2>
    <p>SAFEMARQ est une plateforme de mise en relation entre particuliers et garages automobiles en Belgique. Elle permet la consultation de fiches garages, la publication d'avis et la demande de devis.</p>
    ...
    <ul>
      ...
      <li>SAFEMARQ peut suspendre tout compte en cas d'usage frauduleux.</li>
    </ul>
    ...
    <p>Les demandes de devis sont transmises au garagiste concerné. SAFEMARQ n'est pas partie au contrat conclu entre l'utilisateur et le garagiste.</p>
    ...
    <p>SAFEMARQ fournit une plateforme d'information. Nous ne garantissons pas l'exactitude exhaustive des données et déclinons toute responsabilité quant aux prestations réalisées par les garagistes.</p>
    ...
    <p>SAFEMARQ se réserve le droit de modifier ces CGU à tout moment. Les utilisateurs seront informés des modifications substantielles.</p>
